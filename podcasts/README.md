...
- **Formato:** M4A (AAC), buena calidad y poco peso.

## Duraciones

| Tema | Duración | Tamaño |
|---|---|---|
| `tema-00-overview.m4a` | 8 min | 2 MB |
| `tema-01-actividad-comercial.m4a` | 41 min | 10 MB |
| `tema-02-plan-igualdad.m4a` | 29 min | 7 MB |
| `tema-03-cultura-seguridad.m4a` | 17 min | 4 MB |
| `tema-04-experiencia-cliente.m4a` | 26 min | 6 MB |
| `tema-05-conocimientos-ferroviarios.m4a` | 44 min | 11 MB |
...
Esto vuelve a procesar todos los `.md` de `temario/`, limpia el markdown (quita `#`, `*`, `|`, etc.), expande siglas (AVE → "A V E", FIP → "F I P", etc.) para que la voz las pronuncie bien, y genera los `.m4a`.

## Cómo escucharlos en el móvil

- **iPhone:** arrastra los `.m4a` a Apple Music o a la app Archivos. También puedes subirlos a Drive/Dropbox y escucharlos desde allí.
- **Android:** los `.m4a` se reproducen nativamente con la app de música/podcasts.
